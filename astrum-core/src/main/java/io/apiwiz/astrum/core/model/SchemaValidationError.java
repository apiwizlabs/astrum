...
public class SchemaValidationError {
	...
	@Override public String toString() {
		return "SchemaValidationError{" + "level='" + level + '\'' + ", domain='" + domain + '\'' + ", keyword='" + keyword + '\'' + ", message='" + message + '\'' + ", schema=" + schema + ", instance=" + instance + ", required=" + required + ", missing=" + missing + '}';
	}
}
